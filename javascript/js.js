...
const baguettes = [
  { img: htm, dx: 100, dy: 300, dWidth: 75, dHeight: 150 },
  { img: css, dx: 250, dy: 300, dWidth: 75, dHeight: 150 },
  { img: js, dx: 400, dy: 300, dWidth: 75, dHeight: 150 },
  { img: ang, dx: 550, dy: 300, dWidth: 75, dHeight: 150 },
  { img: vue, dx: 700, dy: 300, dWidth: 75, dHeight: 150 },
  { img: ps, dx: 850, dy: 300, dWidth: 75, dHeight: 150 },
]

function animate() {
  ctx.clearRect(0, 0, canvas.width, canvas.heigth)
  background.rende()
  for ({ img, dx, dy, dWidth, dHeight } of baguettes) {
...
function cinqcollision() {
  if (girl.dx <= obvue.x + 5 && obvue.x <= girl.dx + 10) {
...
function sixcollision() {
  if (girl.dx <= obps.x + 5 && obps.x <= girl.dx + 10) {
